...
void add_char(struct word* _word, char character)
{
    static int size;
...
void add_word(struct sentence* _sentence, struct word* _word)
{
    ...
    _sentence->data = (struct word*)realloc(_sentence->data, _sentence->word_count * sizeof(struct word));
...
void add_sentence(struct paragraph* _paragraph, struct sentence* _sentence)
{
    ...
    _paragraph->data = (struct sentence*)realloc(_paragraph->data, _paragraph->sentence_count * sizeof(struct sentence));
...
void add_paragraph(struct document* _document, struct paragraph* _paragraph)
{
    ...
    _document->data = (struct paragraph*)realloc(_document->data, _document->paragraph_count * sizeof(struct paragraph));
