package com.bce.microservices.camelmicroservice1.routes.b;
...
public class MyFileRouter extends RouteBuilder {
	...
	public void configure() throws Exception {
		...
		from("file:files/input").routeId("Files-Input-Route")
				...
				.when(method(deciderBean)).log("Not an XML FILE BUT contains USD")

				.otherwise().log("Not an XML FILE")

				.end().to("direct://log-file-values").to("file:files/output");
...
class DeciderBean {
	...
	public boolean isThisConditionMet(@Body String body, @Headers Map<String, String> headers,
		...
		logger.info("Body is {} , Headers are {} , ExhangeProperties {}", body, headers, exchangeProperties);
		return true;
	}
}
